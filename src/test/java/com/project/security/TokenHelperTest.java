...
public class TokenHelperTest {
    ...
    public void init() {
        ...
        ReflectionTestUtils.setField(tokenHelper, "SECRET", "project");
    }
    ...
    @Test
    public void mobileTokenShouldExpire() throws Exception{
    ...
    private String createToken(Device device) throws RuntimeException{
